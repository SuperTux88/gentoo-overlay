...
SRC_URI="
	https://github.com/maximbaz/${PN}/archive/refs/tags/${PV}.tar.gz -> ${P}.tar.gz
	https://raw.githubusercontent.com/SuperTux88/gentoo-overlay-deps/main/gui-apps/wluma/${P}-cargo-git-vendor.tar.xz
	$(cargo_crate_uris)
"
...
src_unpack() {
	...
	mv "${WORKDIR}/cargo-git-vendor" "${CARGO_HOME}/git"
}
